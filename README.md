...
- **Quick-jump** — press `1-0` for the first 10, `Option+a-z` for 11+, supporting up to 36 workspaces
...
| Key | Action |
|-----|--------|
| `1-9`, `0` | Jump directly to workspace 1-10 |
| `Option+a-z` | Jump to workspace 11+ (shown as ⌥a, ⌥b, etc.) |
